...
class _StateColorsUI(tk.Frame, _ConfigUIComponent):
    ...
    WHITE = (1, 1, 1), "#FFFFFF"
    BLUE   = (0, 0, 1), "#0000FF"
    DARK_GREEN = (0, 1, 0), "#006400"
    YELLOW = (1, 1, 0), "#FFFF00"
    GREEN = (0.7, 1, 0.2), "#ADFF2F"
    RED   = (1, 0, 0),  "#FF0000"
    DEFAULTCOL = BLACK
    ...
    def __init__(self, parent, ca_config, ca_graph):
        ...
        if self.ca_config.state_colors is None:
            ...
            if len(self.states) == 7:
                ...
                self.selected_colors[2] = self.BLUE[0]
                self.selected_colors[3] = self.DARK_GREEN[0]
                self.selected_colors[4] = self.YELLOW[0]
                self.selected_colors[5] = self.GREEN[0]
                self.selected_colors[6] = self.RED[0]
            else:
